...
export default function Dashboard({
  ...
  const isEndorsementMode = searchParams.get("mode") === "endorsement" || searchParams.get("type") === "endorsement";
  const endorsementPolicyNo = searchParams.get("policyNo") || searchParams.get("q") || "";
  const endorsementInsuredName = searchParams.get("insuredName") || "";
  const endorsementInsurer = searchParams.get("insuranceCompany") || "";
  const endorsementPolicyType = searchParams.get("policyType") || "";
