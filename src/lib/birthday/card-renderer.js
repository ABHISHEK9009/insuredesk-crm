...
/**
 * Generates a personalized Birthday Card image buffer in memory matching the exact design.
 *
...
export async function generateBirthdayCard({ recipientName = "Valued Client" } = {}) {
  ...
  // 3. Draw brand logo at top center (crisp & prominent)
  const logoW = 280;
  ...
  // 7. Draw Wish Poem Text matching exact proportions and styling
  ctx.save();
  ctx.textAlign = "center";
  ctx.textBaseline = "middle";
