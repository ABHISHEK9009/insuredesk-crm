...
const {
  extractLibertyMotor
} = require("./parsers/liberty/index.cjs");
...
function extractPolicyFromTextBase(text, sourceFile = "") {
  ...
  const libertyMotor = extractLibertyMotor(sourceText, sourceFile);
  if (libertyMotor.documentDetected) {
    const legacyData = {
      sourceFile: sourceFile || "Untitled.pdf",
      sourceText,
      status: "saved",
      ...
      documentCategory: "Motor Insurance",
      insuredName: libertyMotor.insuredName,
      contactNumber: libertyMotor.customerMobile,
      contactPerson: libertyMotor.insuredName,
      groupName: deriveGroupName(sourceText, sourceFile, libertyMotor.insuredName),
      policyNumber: libertyMotor.policyNumber,
      policyType: libertyMotor.policyType,
      sumInsured: "0",
      premium: libertyMotor.totalPremium,
      totalPremium: libertyMotor.totalPremium,
      netPremium: libertyMotor.netLiabilityPremium,
      odPremium: libertyMotor.basicOwnDamage,
      tpDriverOwner: libertyMotor.basicThirdPartyLiability,
      startDate: libertyMotor.policyStartDate,
      expiryDate: libertyMotor.policyEndDate,
      duration: buildDuration(libertyMotor.policyStartDate, libertyMotor.policyEndDate) || "",
      riskLocation: "",
      district: "",
      tehsil: "",
      insuranceCompany: libertyMotor.companyName,
      description: "",
      pptMpwlc: "",
      occupancy: "",
      validIn: "",
      vehicleNumber: libertyMotor.registrationNumber,
      registrationNumber: libertyMotor.registrationNumber,
      makeModel: [libertyMotor.vehicleMake, libertyMotor.vehicleModel].filter(Boolean).join("/"),
      variant: libertyMotor.variant,
      manufacturingYear: libertyMotor.manufacturingYear,
      registrationDate: libertyMotor.registrationDate,
      engineNumber: libertyMotor.engineNumber,
      chassisNumber: libertyMotor.chassisNumber,
      fuelType: "PETROL",
      cubicCapacity: libertyMotor.cubicCapacity,
      seatingCapacity: libertyMotor.seatingCapacity,
      grossVehicleWeight: "",
      idv: 0,
      totalIdv: 0,
      ncb: "0",
      policyCoverType: "LIABILITY_ONLY",
      rtoLocation: libertyMotor.rto,
      nomineeName: "",
      financerName: "",
      companyName: libertyMotor.companyName,
      invoiceNumber: "",
      issuanceDate: libertyMotor.issuanceDate,
      communicationAddress: libertyMotor.communicationAddress,
      customerMobile: libertyMotor.customerMobile,
      customerEmail: "",
      vehicleMake: libertyMotor.vehicleMake,
      vehicleModel: libertyMotor.vehicleModel,
      rto: libertyMotor.rto,
      bodyType: "",
      geographicalArea: "INDIA",
      compulsoryDeductible: "0",
      voluntaryDeductible: "0",
      basicOwnDamage: libertyMotor.basicOwnDamage,
      basicThirdPartyLiability: libertyMotor.basicThirdPartyLiability,
      netOwnDamagePremium: libertyMotor.basicOwnDamage,
      netLiabilityPremium: libertyMotor.basicThirdPartyLiability,
      totalPackagePremium: libertyMotor.netLiabilityPremium,
      cgst: "",
      sgst: "",
      gstAmount: libertyMotor.gstAmount,
      previousPolicyNumber: "",
      previousPolicyValidity: "",
      previousInsurer: "",
      previousYearNcb: "",
      ...
      clauses: [],
      specialConditions: [],
      vehicleNumberDisplay: libertyMotor.registrationNumber,
      needsManualReview: false,
      extractionConfidence: 1,
      confidenceScore: 1
    };
  ...
  if (bajajAllianzMotor.documentDetected) {
    const legacyData = {
      ...
      proposalNumber: "",
      invoiceNumber: bajajAllianzMotor.invoiceNumber || "",
      issuanceDate: bajajAllianzMotor.issuanceDate || "",
      ...
      cgst: bajajAllianzMotor.cgst || "",
      sgst: bajajAllianzMotor.sgst || "",
