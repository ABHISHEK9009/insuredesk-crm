...
function train({ text = "", result = {} }) {
  ...
  return {
    ...
    communicationAddress: rawLocationAddress || result.communicationAddress,
    address: rawLocationAddress || result.address,
    insuredAddress: rawLocationAddress || result.insuredAddress,
